          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-white rounded-xl p-8 border-2 border-[#edf2f4] hover:border-[#da1a32] hover:shadow-xl hover:-translate-y-1 transition-all duration-200"
                >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {impactDeliveryCards.slice(0, 3).map((card) => (
              <div
                key={card.title}
                className="bg-white border-2 border-[#edf2f4] rounded-2xl shadow-lg p-7 hover:-translate-y-1 hover:shadow-xl transition-all duration-200"
              >
