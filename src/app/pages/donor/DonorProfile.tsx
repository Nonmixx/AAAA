...
import { User, Mail, Phone, ShieldCheck, Heart, Package, TrendingUp } from 'lucide-react';
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl p-8 border-2 border-[#e5e5e5] shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm mb-2 text-[#000000] font-medium">Account Source</label>
                <div className="relative">
                  <ShieldCheck className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
                  <textarea
                    rows={3}
                    readOnly
                    value="Your login email is managed by Supabase Auth. This profile page edits your donor profile record, including your display name and phone number."
                    className="w-full pl-10 pr-4 py-3 border-2 border-[#e5e5e5] rounded-xl bg-[#edf2f4] text-gray-600"
                  />
                </div>
              </div>
