...
export function DonorLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    { name: 'Home', path: '/donor', icon: null },
    { name: 'Donate', path: '/donor/donate', icon: null },
    { name: 'Browse Needs', path: '/donor/needs', icon: null },
    { name: 'Track', path: '/donor/tracking', icon: null },
  ];
