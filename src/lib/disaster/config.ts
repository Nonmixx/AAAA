function readEnv(name: string): string | null {
  ...
  if (value.startsWith('replace-with-your-')) return null;
  return value;
}
...
export const disasterConfig = {
  zai: {
    ...
    model: readEnv('GLM_MODEL') ?? 'ilmu-glm-5.1',
  },
  signals: {
...
export function requireConfig(value: string | null, message: string): string {
